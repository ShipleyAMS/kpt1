    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#007041] mb-8">Packaging Products</h1>
          
          <div className="prose prose-lg max-w-none text-forest-700 mb-12">
            <p>
              King Tai specializes in premium custom packaging solutions that combine functionality with 
              aesthetic appeal. From luxury gift boxes and jewelry packaging to cosmetic boxes and wine 
              packaging, our products are designed to enhance your brand and create a memorable unboxing 
