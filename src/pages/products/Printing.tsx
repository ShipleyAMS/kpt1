    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#007041] mb-8">Printing Products</h1>
          
          <div className="prose prose-lg max-w-none text-forest-700 mb-12">
            <p>
              King Tai offers a comprehensive range of high-quality printing solutions for various needs. 
              Our printing capabilities cover everything from bibles and books to calendars and catalogues, 
              all produced with meticulous attention to detail and premium materials.
            </p>
          </div>
