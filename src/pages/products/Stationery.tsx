    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#007041] mb-8">Stationery Products</h1>
          
          <div className="prose prose-lg max-w-none text-forest-700 mb-12">
            <p>
              Our premium stationery collection includes notebooks, journals, and planners designed for both 
              functionality and style. Each product is crafted with high-quality materials and can be customized 
              to meet your specific requirements, whether for personal use or corporate branding.
            </p>
          </div>
