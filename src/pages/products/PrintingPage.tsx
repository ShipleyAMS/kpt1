...
const PrintingPage = () => {
  const printingProducts = [
    { name: "Catalogues", image: "/images/placeholder.svg", link: "/products/catalogues" },
    { name: "Leaflets", image: "/images/printing/leaflets/5711bd98-36d2-4420-80b8-76d8febe0aec.png", link: "/products/leaflets" },
    { name: "Books", image: "/images/printing/books/7dd0ed77-bef4-4667-88b1-5f8a749589f2.png", link: "/products/books" },
    { name: "Bibles", image: "/images/printing/bibles/b98f5f4b-72df-44dc-af9a-311dbd32d7b9.png", link: "/products/bibles" },
    { name: "Calendars", image: "/images/printing/calendars/513a1818-3b90-4839-979b-a7279d2b013e.png", link: "/products/calendar" },
    { name: "Game Cards", image: "/images/games/game-cards/870c440a-98b9-472a-9f5c-021a5818c907.png", link: "/products/game-cards" },
    { name: "Greeting Cards", image: "/images/printing/greeting-cards/7d99bcd5-099a-42f0-8760-70f056733a9d.png", link: "/products/greeting-cards" },
    { name: "Tarot Cards", image: "/images/placeholder.svg", link: "/products/tarot-cards" },
    { name: "Jigsaw Puzzles", image: "/images/placeholder.svg", link: "/products/jigsaw-puzzles" },
  ];
