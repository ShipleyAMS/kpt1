        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <a href="#" className="text-white hover:text-forest-300 transition-colors" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#products" className="text-gray-300 hover:text-white transition-colors">Books & Bibles</a>
              </li>
              <li>
                <a href="#products" className="text-gray-300 hover:text-white transition-colors">Packaging Boxes</a>
              </li>
              <li>
                <a href="#products" className="text-gray-300 hover:text-white transition-colors">Shopping Bags</a>
              </li>
              <li>
                <a href="#products" className="text-gray-300 hover:text-white transition-colors">Calendars</a>
              </li>
              <li>
                <a href="#products" className="text-gray-300 hover:text-white transition-colors">Game Cards</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                <MapPin className="h-5 w-5 mr-3 flex-shrink-0 text-forest-300" />
                <span>
              ...
              <li className="flex">
                <Phone className="h-5 w-5 mr-3 flex-shrink-0 text-forest-300" />
                <div>
                  <p>Tel: +86 150 1316 9618</p>
                  <p>WhatsApp: +86 150 1316 9618</p>
                  <p>WeChat: AndyKingTai</p>
                  <p className="text-sm text-gray-400">Contact Person: Andy Zhang</p>
                </div>
              </li>
              <li className="flex">
                <Mail className="h-5 w-5 mr-3 flex-shrink-0 text-forest-300" />
