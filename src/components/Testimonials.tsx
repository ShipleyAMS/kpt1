...
const Testimonials = ({ limit, showControls = true }: { limit?: number, showControls?: boolean }) => {
  ...
  // For home page with limit and carousel navigation
  if (limit) {
    return (
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {displayedTestimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <div className="flex justify-center mb-4">
